...
This policy describes how **Browser** (“the application”) handles information. The application is open-source software. The primary author is **Fedir Tsapana**. Development may also involve a **changing set of voluntary contributors**; you can see the current list on the [GitHub contributors page](https://github.com/truefedex/tvbrowser/graphs/contributors).
...
Browser is a **web browser**. When you browse the internet:
...
https://github.com/truefedex/tvbrowser
