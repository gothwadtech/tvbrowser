...
import com.gothwad.tvbrowser.webengine.gecko.R
...
class MyPromptDelegate(private val webEngine: GeckoWebEngine): GeckoSession.PromptDelegate {
    ...
    override fun onAuthPrompt(
        ...
        if (flags and AuthPrompt.AuthOptions.Flags.ONLY_PASSWORD == 0) {
            ...
            username.setHint(com.gothwad.tvbrowser.common.R.string.username)
        ...
        password.setHint(com.gothwad.tvbrowser.common.R.string.password)
