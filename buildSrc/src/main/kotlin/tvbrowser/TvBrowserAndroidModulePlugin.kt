...
internal object BrowserAndroidModulePlugin {
...
class BrowserAndroidApplicationPlugin : Plugin<Project> {
    override fun apply(project: Project) = BrowserAndroidModulePlugin.configure(project, AndroidModuleType.APPLICATION)
}

class BrowserAndroidLibraryPlugin : Plugin<Project> {
    override fun apply(project: Project) = BrowserAndroidModulePlugin.configure(project, AndroidModuleType.LIBRARY)
}
